...
public class DownloadActivity extends DownloadBase {
    ...
    public void runService(View view) {
        ...
        case R.id.intent_service_button:
        	...
        	Intent intentService = DownloadIntentService.makeIntent(getApplicationContext(), handler, this.getUrlString());
        ...
        case R.id.thread_pool_button:
            ...
            // returned from the makeIntent() factory method.
        	Intent intentPool = ThreadPoolDownloadService.makeIntent(getApplicationContext(), handler, this.getUrlString());
