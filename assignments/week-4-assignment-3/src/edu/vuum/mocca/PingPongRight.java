...
public class PingPongRight {
    ...
    public static class PlayPingPongThread extends Thread {
         ...
         */
        // TODO - You fill in here.
        List<SimpleSemaphore> sSemaphore;
        ...
        public PlayPingPongThread(String stringToPrint,
        	...
        	sSemaphore = new ArrayList<SimpleSemaphore>();
        	sSemaphore.add(semaphoreOne);
        	sSemaphore.add(semaphoreTwo);
        ...
        void acquire() {
            // TODO fill in here
        	sSemaphore.get(FIRST_SEMA).acquireUninterruptibly();
        }
        ...
        void release() {
            // TODO fill in here
        	sSemaphore.get(SECOND_SEMA).release();
        }
    }
    ...
    public static void process(String startString, 
        ...
        PlayPingPongThread ping = new PlayPingPongThread("a", pingSema, pongSema, mMaxIterations );
        PlayPingPongThread pong = new PlayPingPongThread("b", pongSema, pingSema, mMaxIterations );
